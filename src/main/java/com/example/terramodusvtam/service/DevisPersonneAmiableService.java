package com.example.terramodusvtam.service;
...
import com.example.terramodusvtam.repositories.DemandeurPersonneRepository;
import com.example.terramodusvtam.repositories.ImmobRepository;
import com.example.terramodusvtam.repositories.TypeDevisRepository;
import com.example.terramodusvtam.repositories.devisPersonne.DevisPersonneAmiableRepository;
...
public class DevisPersonneAmiableService {
    ...
    public DevisPersonneAmiable saveDevise(DevisPersonneAmiable devise) throws MessagingException, jakarta.mail.MessagingException, JRException, IOException, ParseException, XmlException {
        ...
        emailService.sendHtmlMessage("aazizy.terramodus@gmail.com", "Demande Devis", byteArray, file);
        return savedDevis;
        }
